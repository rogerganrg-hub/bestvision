// apps/api/src/infra/repos/application-repo-sqlite.js
/** @typedef {import("./application-repo.contract.js").ApplicationRepo} ApplicationRepo */
/** @typedef {import("./application-repo.contract.js").Application} Application */
