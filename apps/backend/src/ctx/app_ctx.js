...
import { SqlitePlaidItemRepo } from "../infra/repos/plaid_item_repo_sqlite.js";
import { assemblePlaidIntegration } from "../integrations/plaid/index.js";
import { createPlaidClient } from "../integrations/plaid/plaid_client.js";
...
function openDb() {
  // sqlite 落在 apps/backend/data（与脚本/运维路径统一）
