  ...
  return (
    <main style={{ padding: 24, maxWidth: 860, margin: "0 auto" }}>
      ...
      <p style={{ marginBottom: 16, lineHeight: 1.5 }}>
        Dev-only harness: fetch <code>link_token</code> from backend and open Plaid Link (sandbox). On
      ...
      <p style={{ marginTop: 16, color: "#666" }}>
        Next (P-004): send <code>public_token</code> to backend exchange endpoint to obtain & store{" "}
